...
[![1stDibs Price Tracker](https://img.shields.io/badge/1stDibs%20Price%20Tracker-Managed%20Solution-orange?style=flat-square)](https://brightdata.de/products/insights/price-tracker/1stdibs)
[![Python](https://img.shields.io/badge/Python-3.9%2B-yellow?style=flat-square)](https://python.org)

[![Bright Insights Price Tracker](https://raw.githubusercontent.com/danielshashko/bright-insights-assets/main/price-tracker-hero-v2.png)](https://brightdata.de/products/insights/price-tracker/1stdibs)

Echtzeit-Preisverfolgung für 1stDibs – ein globaler Luxus-Marktplatz für Schmuck, Design und Kunst. Zwei Möglichkeiten für den Einstieg: eine **vollständig verwaltete** Intelligence-Plattform oder ein **benutzerdefinierter Scraper**, erstellt mit Bright Data's AI Scraper Builder.

---

## Option 1: Bright Insights - KI-gestütztes Price Tracking (Empfohlen)

**[Bright Insights](https://brightdata.de/products/insights/price-tracker/1stdibs)** ist Bright Data's vollständig verwaltete Plattform für Retail Intelligence. Keine Scraper zu erstellen, keine Infrastruktur zu warten – nur strukturierte, analysebereite Preisdaten, bereitgestellt für Dashboards, Data Feeds oder Ihre BI-Tools.
...
- ✅ **Überwachen Sie Preise seltener und limitierter Editionen** auf 1stDibs
...
> **Ab $250/Monat – [Individuelles Angebot anfordern →](https://brightdata.de/products/insights/price-tracker/1stdibs)**

---

## Option 2: Erstellen Sie Ihren eigenen 1stDibs Scraper

Keine vorgefertigte 1stDibs scraper API? Kein Problem. Bright Data's **AI Scraper Builder** generiert in nur wenigen Klicks einen benutzerdefinierten 1stDibs Scraper — ganz ohne Programmierung.

### Erstellen Sie Ihren 1stDibs Scraper in wenigen Minuten

**[Öffnen Sie den 1stDibs AI Scraper Builder →](https://brightdata.de/products/web-scraper/1stdibs)**
...
- Eine **Web Scraper ID** für 1stDibs (aus dem Build-Schritt oben)
...
1. **Klonen Sie dieses repository**
   ...
   ```bash
   git clone https://github.com/bright-data-de/1stdibs-price-tracker.git
...
3. **Konfigurieren Sie die Zugangsdaten**
   ...
   > **Ihre Web Scraper ID**
   > Fügen Sie die Web Scraper ID aus Ihrem [AI Scraper Builder dashboard](https://brightdata.de/products/web-scraper/1stdibs)
...
Sobald Ihr 1stDibs Scraper erstellt wurde und Ihre Web Scraper ID in `.env` konfiguriert ist, funktioniert die Python-Schnittstelle auf die gleiche Weise:

### 1. Bestimmte Produkte per URL verfolgen

Übergeben Sie eine Liste von 1stDibs-Produkt-URLs, um strukturierte Preisdaten abzurufen:
...
Sammeln Sie alle Produkte von einer 1stDibs-Kategorieseite:
...
- 🌟 [1stDibs Price Tracker - Bright Insights (Managed)](https://brightdata.de/products/insights/price-tracker/1stdibs)
- 🏗️ [Einen 1stDibs Scraper erstellen](https://brightdata.de/products/web-scraper/1stdibs)
